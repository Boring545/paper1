...
// 计算剩余干涉R_t_i：在时刻upper时 release的优先级 i
// 任务所面对的之前高优先级任务未完成的剩余执行时间,lower=upper-T_i+D_i
...
bool assign_priority(CanfdFrameMap& frame_map, PRIORITY_ASSIGN_METHOD method = DEFAULT_PRIORITY_ASSIGN_METHOD);
